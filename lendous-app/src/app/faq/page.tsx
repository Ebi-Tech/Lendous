...
const FAQSection: React.FC = () => {
  ...
  return (
    <section id="faq" className="py-20 sm:py-24 px-4 sm:px-6 lg:px-8 bg-[#FFFFFF]">
        ...
        <div className="flex flex-col md:flex-row items-center gap-12 mb-10 sm:mb-12">
          <div className="md:w-1/2 text-center md:text-left">
            ...
            <motion.p
              ...
              className="mt-8 text-lg sm:text-xl font-medium italic text-gray-700 max-w-4xl mx-auto md:mx-0"
            >
