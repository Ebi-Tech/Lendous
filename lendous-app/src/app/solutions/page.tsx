      ...
      sections: [
        {
          ...
          description: `We create targeted growth and actively identify, nurture, and secure new revenue streams for your company. This means:\n* Strategic Opportunity Discovery: We pinpoint and engage with the right companies and decision-makers who need your services.\n* Relationship Building: We initiate and cultivate valuable connections that lead to genuine interest in your offerings.\nQualified Lead Generation: We deliver pre-vetted prospects who are ready to discuss how your products can solve their problems.\nThe outcome for you? A consistent flow of high-potential sales opportunities, directly translating into new clients and increased revenue, without you lifting a finger.`,
          image: "/images/supply-chain.jpg",
          imagePosition: "left",
        },
        {
          title: "Run and Expand Operations Profitably",
          subtitle: "with systems & process automation",
          description:
            "Lendous provides medium & large organizations with tailored systems & process automation and expansion blueprint. We evaluate your current (As-Is) state, with your (To-Be) state, and build solutions that meet your needs",
      ...
      >
        ...
        <div className="py-12 sm:py-16 relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center gap-8 sm:gap-12 text-center">
          <div className="space-y-6 sm:space-y-10 px-4 sm:px-0">
            ...
            >
              From launching your business to scaling across markets, we've got
              you covered.
            </motion.p>
                          ...
                          <SlideInSection
                            ...
                            className={`flex flex-col ${
                              section.imagePosition === "right"
                                ? "md:flex-row-reverse"
                                : "md:flex-row"
                            } items-center gap-8 sm:gap-12 mb-12`}
                          >
                            ...
                            <div className="w-full md:w-1/2 text-center md:text-left order-2">
                              ...
                              {section.subtitle && (
                                <p className="text-lg sm:text-xl font-medium text-indigo-600 mb-3">
                                  {section.subtitle}
                                </p>
                              )}
                              {Array.isArray(section.description) ? (
                                <ul className="list-disc ml-6 space-y-2 text-[12px] sm:text-[14px] text-gray-600 leading-relaxed">
                                  {section.description.map((point, index) => (
                                    <li key={index}>{point}</li>
                                  ))}
                                </ul>
                              ) : (
                                <p className="text-[12px] sm:text-[14px] text-gray-600 leading-relaxed whitespace-pre-wrap">
                                  {section.description}
                                </p>
                              )}
                              <motion.button
